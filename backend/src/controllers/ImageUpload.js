...
exports.uploadImage =async (req, res) => {
    const {complaintLocation, complaintDate, complaintDescription} = req.body; // Access additional fields
    ...
    // if (!complaintLocation || !complaintDescription || !complaintDate) {
    ...
    await ComplaintModel.create({
        ...
        complaintImage: cloudinaryResponse.url, // Store the file path in the database
    }).then(() => {
